...
export const getDeliveryMethods = (method: DeliveryMethod): SelectedDeliveryMethodVM => {
  ...
  return {
    methods: deliveryMethods.map((method: DeliveryMethod) => {
      return {
        ...
        price:
          method.price === 0 ||
          (cart.totalWithPromotion > 3900 && method.uuid === '505209a2-7acb-4891-b933-e084d786d7ea ')
            ? 'Gratuit'
