...
import { CheckoutCartVM, GetCheckoutCartVM } from '@adapters/primary/viewModels/get-checkout/GetCheckoutCartVM';
import {
  CheckoutContactVM,
...
export class GetCheckoutVM {
  ...
  private _shippingAddressVM: GetCheckoutShippingAddressVM = new GetCheckoutShippingAddressVM();
  private _total = 0;
  ...
  private canValidate(): boolean {
    return (
      this._cartVM.isValid && this._contactVM.isValid && this._shippingAddressVM.isValid && this._deliveryVM.isValid
    );
  }
}
