<template>
  <section class="on-parle-de-nous px-4 py-8">
    <h1 class="text-4xl font-bold mb-8 text-center text-[#E5017D]">On parle de nous</h1>

    <!-- Liste des Articles -->
    <div class="articles grid gap-8">
      <!-- Article 1 -->
      <div class="p-6 border rounded-lg shadow hover:shadow-lg transition-shadow">
        <a
          target="_blank"
...
.article h3 {
  color: #3b82f6; /* Bleu pour les sous-titres */
}
...
.text-[#E5017D] {
  color: #3b82f6; /* Exemple de couleur principale, ajustez selon votre thème */
}
</style>
